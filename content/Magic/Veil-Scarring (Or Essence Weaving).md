---
{"publish":"true","created":"2026-01-11T15:51:05.000+01:00","modified":"2026-01-16T03:46:34.064+01:00","published":"2026-01-16T03:46:34.064+01:00","cssclasses":""}
---
...
- New attribute: **Essence Attunement** (EA)
    - (IQ + HT)/2
    - 10 CP/lvl
    - Governs “Essence Reserve” (At default ER = EA, Can be bought up, up to 30% over EA, Can **not** be bought down)
...
<br>
- **Essence Reserve**
    - Spells can only be paid for with ER, **not** with regular FP!
...
- Each discipline of magic has its own Weaving Empowerment
...
- **Temporary Preparation:**
    ...
    - Requires 1 hour of preparation/memorization
    - Requires an EA-based Thaumatology Roll + Talent-Bonus
    - Once prepared, the weaving is treated as “known” and can be cast normally until "overwritten" 
        
- **Desperate Preperation:**
    
    - Uses **total CP** spend on (Instead of Level in) “Weaving Empowerment” to determine which spells can be prepared
    - Also requires a scroll or similar **detailed** written account in order to prepare a spell
    - Also requires 1 hour of preperation/memorization
    - Requires an EA-based Thaumatology Roll + Talent-Bonus
...
- Penalties can be balanced out by spending more ER and/or adjusting the casting parameters
